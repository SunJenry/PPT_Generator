...
The sections must together cover 25-30 slides. Fact verification will be handled
automatically during content generation, so do not list fact queries here.
